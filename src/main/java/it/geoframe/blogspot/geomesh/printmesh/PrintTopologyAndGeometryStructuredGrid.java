...
public class PrintTopologyAndGeometryStructuredGrid {
	...
	public void process() {
		...
		try (PrintWriter csvWriter = new PrintWriter(new FileWriter(csvFile));){
			...
			csvWriter.println("#Element,edge_1,edge_2,edge_3,edge_4");
			for(int i=1; i<elementEdgesSet.size(); i++){
				csvWriter.println(i + "," + elementEdgesSet.get(i).get(0) + "," + elementEdgesSet.get(i).get(1) + "," + elementEdgesSet.get(i).get(2) + "," + elementEdgesSet.get(i).get(3));
			}
