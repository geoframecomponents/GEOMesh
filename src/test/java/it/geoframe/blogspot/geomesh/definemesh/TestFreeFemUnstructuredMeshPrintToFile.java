...
public class TestFreeFemUnstructuredMeshPrintToFile {
	...
	public void Test() throws Exception {
		...
		print.fileName = "resources/output/gmsh_unstructured_topology_geometry.csv";
		...
		File file1 = new File("resources/output/gmsh_unstructured_topology_geometry_reference.csv");
		File file2 = new File("resources/output/gmsh_unstructured_topology_geometry.csv");
